...
namespace ILRuntime.Runtime.Generated
{
    unsafe class ETModel_ETAsyncTaskMethodBuilder_1_AssetBundle_Binding
    {
        ...
        static StackObject* Start_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.GetObjectAndResolveReference(ptr_of_this_method);
            object instance_of_this_method = (ETModel.ETAsyncTaskMethodBuilder<UnityEngine.AssetBundle>)typeof(ETModel.ETAsyncTaskMethodBuilder<UnityEngine.AssetBundle>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
        ...
        static StackObject* get_Task_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            ptr_of_this_method = ILIntepreter.GetObjectAndResolveReference(ptr_of_this_method);
            ETModel.ETAsyncTaskMethodBuilder<UnityEngine.AssetBundle> instance_of_this_method = (ETModel.ETAsyncTaskMethodBuilder<UnityEngine.AssetBundle>)typeof(ETModel.ETAsyncTaskMethodBuilder<UnityEngine.AssetBundle>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
        ...
        static StackObject* AwaitUnsafeOnCompleted_3(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 2);
            ETModel.ETTask<UnityEngine.AssetBundle> @awaiter = (ETModel.ETTask<UnityEngine.AssetBundle>)typeof(ETModel.ETTask<UnityEngine.AssetBundle>).CheckCLRTypes(__intp.RetriveObject(ptr_of_this_method, __mStack));
