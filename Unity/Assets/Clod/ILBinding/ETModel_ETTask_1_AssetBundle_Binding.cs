...
namespace ILRuntime.Runtime.Generated
{
    unsafe class ETModel_ETTask_1_AssetBundle_Binding
    {
        ...
        static StackObject* SetResult_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ETModel.ETTask<UnityEngine.AssetBundle> instance_of_this_method = (ETModel.ETTask<UnityEngine.AssetBundle>)typeof(ETModel.ETTask<UnityEngine.AssetBundle>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
