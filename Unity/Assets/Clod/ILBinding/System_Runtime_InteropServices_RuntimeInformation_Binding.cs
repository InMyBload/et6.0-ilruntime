...
{
    unsafe class System_Runtime_InteropServices_RuntimeInformation_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(System.Runtime.InteropServices.RuntimeInformation);
            args = new Type[]{typeof(System.Runtime.InteropServices.OSPlatform)};
            method = type.GetMethod("IsOSPlatform", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, IsOSPlatform_0);
